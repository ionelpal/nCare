...
extern void *mono_aot_module_nc_info;
...
extern void *mono_aot_module_nccloud_info;
...
{
	mono_aot_register_module (mono_aot_module_nc_info);
	...
	mono_aot_register_module (mono_aot_module_nccloud_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("Xamarin.Forms.Maps.iOS.dll");
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "nc.exe";
